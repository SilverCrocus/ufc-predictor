...
from ufc_predictor.ensemble_manager import UFCEnsembleManager, EnsemblePrediction
...
class EnhancedUFCPredictionService(UFCPredictionService):
    ...
    def __init__(self, betting_system: Dict[str, Any], 
        ...
        if self.confidence_calculator is None:
            from ufc_predictor.utils.confidence_intervals import create_ufc_confidence_calculator
    ...
    def _initialize_ensemble_manager(self):
        ...
        try:
            ...
            if rf_model and xgb_model:
                from ufc_predictor.ensemble_manager import create_default_ensemble_manager
    ...
    def _predict_with_ensemble(self, odds_data: Dict[str, Dict], 
        ...
        from ufc_predictor.utils.validation import validate_ufc_fighter_pair, validate_ufc_prediction_dataframe, FighterNameValidationError, DataFrameValidationError
