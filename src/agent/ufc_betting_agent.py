        ...
        if self.hybrid_odds_service:
            try:
                ...
                status['quota_management'] = {
                    'requests_used_today': quota_status['quota_status']['requests_used_today'],
                    'requests_remaining_today': quota_status['quota_status']['requests_remaining_today'],
                    'budget_remaining': quota_status['quota_status']['budget_remaining'],
                    'api_efficiency': quota_status['hybrid_service_metrics'].get('api_efficiency', 0)
                }
            except Exception as e:
